...
public class Register {
	...
	public void error_should_display_for_duplicate_email_address() {
		...
		Assert.assertEquals(
				driver.findElement(By.xpath("//input[@id=\"input-firstname\"]/following-sibling::div")).getText(), "First Name must be between 1 and 32 characters!");
	   Assert.assertEquals(
			   driver.findElement(By.xpath("//input[@id=\"input-lastname\"]/following-sibling::div")).getText(), "Last Name must be between 1 and 32 characters!");
